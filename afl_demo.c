...
//todo 两者dry_run的不同点无外乎是
// 1. 建立kl_message，
// 2. update_state_aware_variables
// 3.保存replaying的种子
// 4. delete_kl_messages(kl_messages);
void dry_run(int stage){
...
//        u8 res;
        ...
        // 这里是为了确定每个testcase都可以用，用来设置use_memory
...
//        res = calibrate_case(argv, q, use_mem, 0, 1);
        ...
        if (fault == crash_mode || fault == FAULT_NOBITS)
